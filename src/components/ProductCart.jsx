    ...
    <section className="container p-3">
      ...
      <div className="row row-cols-1 row-cols-lg-2 py-4 ">
        <div className="pe-2 h-100">
          <div>
            <img src={img} className="product-karzinka-card-img w-100" alt="" />
          </div>
      ...
      <div className="card-shadow p-3">
        ...
        <div className={display[0][0]}>
          <p>
            ...
            большими боковыми нагрузками на лезвие ножа, ввиду небольшой толщины
            клинка в рабочей части.
            <br />
          ...
          <div className="d-flex gap-4 border-bottom pb-2 mt-3">
            ...
            <div>
              ...
              <p className="my-3">
                ...
                consequatur voluptatum ipsum eveniet mollitia architecto dolorum
                sequi sapiente, nam atque aliquam deserunt facere? Saepe minima,
                eaque et
              </p>
